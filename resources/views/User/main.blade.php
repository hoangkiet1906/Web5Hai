...
<head>
    ...
    <meta name="msapplication-TileImage" content="{{ asset('User/assets/images/favicon/cropped-favicon-270x270.png')}}" />
                        ...
                        <div class="col-lg-6 col-6">
                            <div class="language-currency-wrap">
                                ...
                                <div class="language-wrap">
                                    <a class="language-active" href="#"><img src="{{ asset('User/assets/images/icon-img/flag.png')}}" alt=""> English <i class=" ti-angle-down "></i></a>
                                    <div class="language-dropdown">
                                        <ul>
                                            <li><a href="#"><img src="{{ asset('User/assets/images/icon-img/flag.png')}}" alt="">English </a></li>
                                            <li><a href="#"><img src="{{ asset('User/assets/images/icon-img/spanish.png')}}" alt="">Spanish</a></li>
                                            <li><a href="#"><img src="{{ asset('User/assets/images/icon-img/arabic.png')}}" alt="">Arabic </a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="logo">
                                <a href="{{route('home')}}"><img src="{{ asset('User/assets/images/logo/logo.png')}}" alt="logo"></a>
                            </div>
                        </div>
                                            ...
                                            <ul class="mega-menu-style mega-menu-mrg-1">
                                                <li>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="shop.html"><img src="{{ asset('User/assets/images/banner/menu.png')}}" alt=""></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="footer-widget footer-about mb-40">
                                    <div class="footer-logo">
                                        <a href="index.html"><img src="{{ asset('User/assets/images/logo/logo.png')}}" alt="logo"></a>
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, cons adipi elit, sed do eiusmod tempor incididunt ut aliqua.</p>
                                    <div class="payment-img">
                                        <a href="#"><img src="{{ asset('User/assets/images/icon-img/payment.png')}}" alt="logo"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="row gx-0">
                            <div class="col-lg-5 col-md-5 col-12">
                                <div class="modal-img-wrap">
                                    <img src="{{ asset('User/assets/images/product/quickview.png')}}" alt="">
                                </div>
                            </div>
